...
class Scene:
    def __init__(self, width=800, height=600, background_color=(0, 0, 0), title="Scene", icon="SimLabEngineLogo.png"):
        ...
        # Construct the absolute path for the icon relative to the scene folder
    ...
    def simulate(self, duration=10, fps=60):
        time_elapsed = 0
        while self.running and time_elapsed < duration:
            ...
            # Calculate real delta time and scale it
